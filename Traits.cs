...
namespace Cave
{
    public class Traits
    {
        ...
        public class MaterialTraits
        {
            ...
            public (int type, int subType, int megaType)? transformOnGathering;
            public ColorRange colorRange;
            //public float biomeColorBlend;
        ...
        public static void makeMaterialTraitsDict()
        {
            materialTraitsDict = new Dictionary<(int type, int subType), MaterialTraits>()
            {
                ...
                col:new ColorRange((50, 0, 30), (170, 50, 30), (50, 0, 30))                                             ) },
                { (1, -1), new MaterialTraits("Plant Matter 2 (for cool colors)", F:(75, 250), bT:((7, 0), true, 2), tOG:(1, 0, 3),
                col:new ColorRange((50, 0, 30), (170, 50, 30), (50, 0, 30))                                             ) },
                { (1, 0), new MaterialTraits("Plant Matter", F:(75, 250), bT:((7, 0), true, 2),
                col:new ColorRange((50, 0, 30), (170, 50, 30), (50, 0, 30))                                             ) },
                { (1, 1), new MaterialTraits("Wood", F:(100, 500), bT:((4, 0), false, 100), tool:(4, 0, 4),
                col:new ColorRange((140, 20, 30), (140, 20, 30), (50, 0, 30))                                           ) },
                { (1, 2), new MaterialTraits("Kelp", F:(75, 250), bT:((7, 0), true, 2), 
                col:new ColorRange((30, 0, 30), (90, 50, 30), (140, -50, 30))                                           ) },
                { (1, 3), new MaterialTraits("Obsidian Plant Matter",
                col:famousColorRanges["Obsidian"]                                                                       ) },
                { (1, 4), new MaterialTraits("Grain", F:(75, 250), bT:((7, 0), true, 2),
                col:famousColorRanges["CerealGrain"]                                                                    ) },

                { (2, -1), new MaterialTraits("Petal 2 (for cool colors)", F:(75, 250), bT:((7, 0), true, 2), tOG:(2, 0, 3),
                col:new ColorRange((170, 20, 30), (120, 0, 30), (150, -20, 30))                                         ) },
                { (2, 0), new MaterialTraits("Petal", F:(75, 250), bT:((7, 0), true, 2),
                col:new ColorRange((170, 20, 30), (120, 0, 30), (150, -20, 30))                                         ) },
                { (2, 1), new MaterialTraits("Pollen", F:(75, 250), bT:((7, 0), true, 2),
                col:new ColorRange((170, -10, 30), (170, 10, 30), (50, 0, 30))                                          ) },

                { (3, 0), new MaterialTraits("Mushroom Stem", F:(35, 100), bT:((7, 0), true, 2),
                col:new ColorRange((180, 0, 30), (160, 0, 30), (165, 0, 30))                                            ) },
                { (3, 1), new MaterialTraits("Mushroom Cap", F:(25, 75), bT:((7, 0), true, 2),
                col:new ColorRange((140, 0, -30), (120, 50, 0), (170, -50, 0))                                          ) },
                { (3, 2), new MaterialTraits("Mold", F:(15, 60), bT:((7, 0), true, 2),
        ...
        public static void makeEntityTraitsDict()
        {
            ...
            {  // R              G               B     ->     (Color, hue, shade)
                ...
                dT:new HashSet<(int type, int subType)>{ (6, 0), (6, 1), (-2, -1) },
                iW:2, oW:2, iA:0, oG:3, iG:2) },
                ...
                biomeCR:new Dictionary<(int type, int subType), ColorRange>()
                {
                    ...
                    { (2, 5), new ColorRange((170, 0, 15), (135, 0, 15), (110, 15, 15)) },      // Brown desert
                    { (2, 6), new ColorRange((195, 0, 15), (135, 0, 15), (90, 15, 15)) },       // Orange desert
                    { (2, 7), new ColorRange((140, -10, 15), (130, -10, 15), (125, 10, 15)) },  // Gray desert
                },
                tM:new (int segment, bool fromEnd, bool oriented, int angleMod, (int x, int y) pos, (bool isVariation, int? lightRadius, (int a, int r, int g, int b) value)? color)[]
                {
                ...
                dT:new HashSet<(int type, int subType)>{ (8, 0), (8, 1), (8, 2), (8, 3), (8, 4), (9, 0), (9, 1), (9, 2), (9, 3), (9, 4), },
                iW:3, oW:2, iA:0, oG:3, iG:2) },
        ...
        public class PlantGrowthRules
        {
            ...
            public float? liquidIncreasesMaxGrowth;
            ...
            public bool sameChanceForEndChildren;
            public int preventGapsOnChildSpawn;
            public bool loopChild;
            public float? liquidIncreasesChildOffset;
            public bool transmitStickyChildrenOnGrowthEnd;
            public bool doNotApplyGrowthSpeedVariationToChildren;
            ...
            public (float baseValue, float variation, float maxGrowthScaling) dGOffset;
            public bool rotationalDG;
            public bool loopDG;
            public float? liquidIncreasesDGOffset;
            ...
            public (float baseValue, float variation, float maxGrowthScaling) pMOffset;
            public bool loopPM;
            public float? liquidIncreasesPMOffset;
            ...
            public (float baseValue, float variation, float maxGrowthScaling) eWoffset;
            public bool loopEW;
            ...
            public PlantGrowthRules((int type, int subType) t, ((int type, int subType) material, int threshold, int variation, bool fromEnd)[] fWOM = null, (int type, int subType)[] tCNTG = null,
                ...
                ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] C = null, (float baseValue, float variation, float maxGrowthScaling)? cO = null, bool lC = false, float? lICO = null, int pGOCS = 0, bool tSCOGE = false, bool dNAGSVTC = false, bool sCFEC = false, bool mTC = false,    // O O OOOO I. WANT A HEN-
                ((int x, int y) direction, (bool x, bool y, bool independant) canBeFlipped)? sD = null,
                ((int x, int y) direction, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] DG = null, (float baseValue, float variation, float maxGrowthScaling)? dGO = null, bool rDG = false, bool lDG = false, float? lIDGO = null,
        ...
        public class PlantElementTraits
        {
                ...
                bool isReg = false, bool fLAP = false, int lR = 0, (int type, int subType)? lE = null, bool iC = false, (int type, int subType, int subSubType)? tTOPEOGE = null)
            {
                ...
                if (plantGrowthRules != null)
                {
                    ...
                    if (plantGrowthRules.fillWithOtherMaterial != null) { foreach (((int type, int subType) material, int threshold, int variation, bool fromEnd) item in plantGrowthRules.fillWithOtherMaterial) { materialsPresent.Add(item.material); } }
                }
                else if (frames != null)
                {
        ...
        public static void makePlantElementTraitsDict()
        {
            plantElementTraitsDict = new Dictionary<(int type, int subType, int subSubType), PlantElementTraits>()
            {
                ...
                { (0, 0, 0), new PlantElementTraits("GrassStem",
                ...
                { (1, 0, 1), new PlantElementTraits("TulipSuaveFlower", stick:((0, 1), (false, false)),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0), (2, 1) }, "TulipSuaveFlower", 5)
                ) },
                ...
                { (1, 3, 0), new PlantElementTraits("BluebellStem", rET:(from number in Enumerable.Range(0, 12) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(3, 3), hPP:fHPP["Up1Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 3, 1), 0, (1, 0), 0, 35) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((1, 3, 1), 0, (0, -1), 0, (1, 0), 100), ((1, 3, 1), 0, (0, 0), 0, (0, 0), 50) },
                    cO:(2, 0, 0), lC:true,
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (2, 1), 100), ((1, 0), (true, false, false), (1, 2), 100) },
                    dGO:(-1.5f, 0, 0.5f)
                )) },
                { (1, 3, 1), new PlantElementTraits("BluebellFlower",
                ...
                { (1, 4, 0), new PlantElementTraits("DragonsMouthOrchidStem", rET:(from number in Enumerable.Range(0, 3) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(1, 1), hPP:fHPP["Up2Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 4, 1), 0, (0, 1), 0, 100) }
                )) },
                { (1, 4, 1), new PlantElementTraits("DragonsMouthOrchidFlower",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "SinglePixel", 1)
                ) },

                { (1, 5, 0), new PlantElementTraits("RosePogoniaStem", rET:(from number in Enumerable.Range(0, 4) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(2, 1), hPP:fHPP["Up2Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 5, 1), 0, (0, 1), 0, 100) }
                )) },
                { (1, 5, 1), new PlantElementTraits("RosePogoniaFlower",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "SinglePixel", 1)
                ) },

                { (1, 6, 0), new PlantElementTraits("SmallWhiteLadysSlipperStem", rET:(from number in Enumerable.Range(0, 3) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(0, 1), hPP:fHPP["Up2Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 6, 1), 0, (0, 1), 0, 100) }
                )) },
                { (1, 6, 1), new PlantElementTraits("SmallWhiteLadysSlipperFlower",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "SinglePixel", 1)
                ) },

                { (1, 7, 0), new PlantElementTraits("PoisonFlagStem", rET:(from number in Enumerable.Range(0, 6) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(3, 2), hPP:fHPP["Up2Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[]{ ((1, 7, 1), 0, (0, 1), 0, 100) },
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 7, -1), 5, (-1, 0), 0, 65 ), ((1, 7, -1), 5, (1, 0), 0, 35 ) },
                    lC:true, lICO:1,
                ...
                { (1, 7, -1), new PlantElementTraits("PoisonFlagLeaf",
                pGR:new PlantGrowthRules(t:(1, 0), mG:(2, 1), sD:((0, 1), (true, false, false)), hPP:fHPP["Up1Gap"],
                ...
                { (1, 7, 1), new PlantElementTraits("PoisonFlagFlower",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "SinglePixel", 1)
                ) },

                { (1, 8, 0), new PlantElementTraits("GoldenrodStem", rET:(from number in Enumerable.Range(0, 12) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(5, 3), hPP:fHPP["Up4Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 8, 3), 0, (0, 1), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((1, 8, 1), 5, (-1, 0), 0, (0, 0), 100), ((1, 8, 1), 5, (1, 0), 0, (0, 0), 100),     ((1, 8, 2), 5, (-1, 0), 0, (1, 0), 100), ((1, 8, 2), 5, (1, 0), 0, (1, 0), 50),   ((1, 8, -1), 5, (-1, 1), 0, (0, 0), 100), ((1, 8, -1), 5, (1, 1), 0, (1, 0), 75),   ((1, 8, 4), 5, (-1, 1), 0, (1, 0), 100), ((1, 8, 4), 5, (1, 1), 0, (1, 0), 100), ((1, 8, 4), 5, (-1, 1), 0, (1, 0), 100), ((1, 8, 4), 5, (1, 1), 0, (1, 0), 100) },
                ...
                { (1, 8, -1), new PlantElementTraits("GoldenrodBranch",
                pGR:new PlantGrowthRules(t:(1, 0), mG:(1, 0),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 8, 4), 5, (1, 1), 0, 100) }
                )) },
                { (1, 8, 1), new PlantElementTraits("GoldenrodLeaf", fMG:(1, 0),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "LongHorizontalBar", 10),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((110, -5, 15), (135, -5, 15), (55, 10, 10))) }) },
                { (1, 8, 2), new PlantElementTraits("GoldenrodLeafShort",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "SinglePixel", 1),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((110, -5, 15), (135, -5, 15), (55, 10, 10))) }) },
                { (1, 8, 3), new PlantElementTraits("GoldenrodFlowerVertical", fMG:(1, 1),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "LongVerticalBar", 10),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), null) }) },
                { (1, 8, 4), new PlantElementTraits("GoldenrodFlowerShort",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "SinglePixel", 1),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), null) }) },

                { (1, 9, 0), new PlantElementTraits("WildSageStem",
                pGR:new PlantGrowthRules(t:(1, 0), mG:(5, 2), hPP:fHPP["Up1Gap"],
                    fWOM:new ((int type, int subType) material, int threshold, int variation, bool fromEnd)[]{ ((2, 0), 3, 1, true) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 45), }
                )) },

                { (1, 10, 0), new PlantElementTraits("NoddingSageStem",
                pGR:new PlantGrowthRules(t:(1, 0), mG:(4, 2), hPP:fHPP["Up1Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[]{ ((1, 10, 1), 1, (1, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((1, 10, 1), 1, (1, 0), 0, (2, 0), 50), ((1, 10, 1), 1, (-1, 0), 0, (1, 1), 90) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 35), }
                )) },
                { (1, 10, 1), new PlantElementTraits("NoddingSageFlower", fMG:(1, 2),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "NoddingSageFlower", 4)
                ) },

                { (1, 11, 0), new PlantElementTraits("TulipWildStem", rET:(from number in Enumerable.Range(0, 6) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(2, 1), hPP:fHPP["Up3GapX3Gap"],
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((1, 11, 1), 0, (0, 1), 0, (1, 0), 100) }
                )) },
                { (1, 11, 1), new PlantElementTraits("TulipWildFlower", stick:((0, 1), (false, false)),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "TulipWildFlower", 3)
                ) },

                { (1, 12, 0), new PlantElementTraits("NoddingThistleBase", rET:(from number in Enumerable.Range(0, 12) select ((0, number), (true, false))).ToArray(), sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 1), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 1), mG:(0, 0), hPP:fHPP["Up1Gap"],
                    cOGESp:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (float baseValue, float variation)? childMaxGrowthVariation, (float baseValue, float variation)? forceGrowthSpeedVariationFactor, int chance)[] { ((1, 12, -1), 0, (0, 0), 0, null, (2.5f, 5), 100), ((1, 12, -1), 7, (-1, 0), 0, (-2, 1), (0.75f, 0.5f), 65), ((1, 12, -1), 7, (1, 0), 0, (-2, 0), (0.75f, 0.5f), 35) },
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 12, 2), 6, (1, 1), 0, 100), ((1, 12, 2), 6, (-1, 1), 0, 100) }
                )) },
                { (1, 12, -1), new PlantElementTraits("NoddingThistleStem", sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 1), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 0), mG:(4, 3), sD:((0, 1), (true, false, true)), hPP:fHPP["Up1Gap"],
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((1, 12, 1), 1, (1, 0), 0, 100 ) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((1, 12, 3), 0, (-1, 0), 0, (1, 1), 90), ((1, 12, 3), 0, (1, 0), 0, (1, 1), 90) },
                    lC:true, dNAGSVTC:true,
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (2, 0), 100), ((1, 0), (true, false, false), (3, 0), 100), ((1, 0), (true, false, false), (4, 0), 100), }
                ), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), null) }) },
                { (1, 12, 1), new PlantElementTraits("NoddingThistleFlower", stick:((0, 1), (false, false)), fMG:(1, 3),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0), (1, 0) }, "NoddingThistleFlower", 5),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), null), ((1, 0), new ColorRange((120, 0, 15), (125, 10, 15), (115, -5, 15))) }
                ) },
                { (1, 12, 2), new PlantElementTraits("NoddingThistleLeaves", fMG:(1, 0),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "LongHorizontalBar", 10),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), null) }
                ) },
                { (1, 12, 3), new PlantElementTraits("NoddingThistleLeavesSmall",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "SinglePixel", 1)
                ) },
                ...
                pGR:new PlantGrowthRules(t:(1, 0), mG:(6, 4), lIMG:1, hPP:fHPP["Up1Gap"],
                    ...
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((2, 2, -1), 1, (-1, 0), 0, (1, 1), 75 ), ((2, 2, -1), 1, (1, 0), 0, (1, 1), 75 ) },
                    lC:true, lICO:1,
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 10), ((1, 0), (true, false, false), (3, 2), 60) }
                )) },
                ...
                { (3, 5, 0), new PlantElementTraits("GlaucousParnassiaBase", rET:(from number in Enumerable.Range(0, 12) select ((0, number), (true, false))).ToArray(), sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 1), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 1), mG:(0, 0), hPP:fHPP["Up1Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[]{ ((3, 5, -1), 0, (0, 0), 0, 100), ((3, 5, -1), 5, (-1, 0), 0, 65), ((3, 5, -1), 5, (1, 0), 0, 25) }
                )) },
                { (3, 5, -1), new PlantElementTraits("GlaucousParnassiaStem", sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 1), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 0), mG:(1, 2), sD:((0, 1), (true, false, true)), hPP:fHPP["Up1Gap"],
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((3, 5, 1), 0, (0, 1), 0, 100 ), ((3, 5, 2), 0, (1, 1), 0, 75), ((3, 5, 2), 0, (-1, 1), 0, 35) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 1), 35), }
                ), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), null) }) },
                { (3, 5, 1), new PlantElementTraits("GlaucousParnassiaFlower", stick:((0, 1), (false, false)),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "SinglePixel", 1),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), null) }
                ) },
                { (3, 5, 2), new PlantElementTraits("GlaucousParnassiaLeaves",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "SinglePixel", 1),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), null) }
                ) },

                { (3, 6, 0), new PlantElementTraits("MarshCinquefoilStem", rET:(from number in Enumerable.Range(0, 12) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(4, 2), hPP:fHPP["Up4Gap"],
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((3, 6, 3), 0, (0, 1), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((3, 6, 1), 5, (-1, 0), 0, (0, 0), 100), ((3, 6, 1), 5, (1, 0), 0, (1, 0), 100),     ((3, 6, 2), 5, (-1, 0), 0, (1, 0), 100), ((3, 6, 2), 5, (1, 0), 0, (1, 0), 90), ((3, 6, 2), 5, (-1, 0), 0, (1, 1), 50) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 25) }
                )) },
                { (3, 6, 1), new PlantElementTraits("MarshCinquefoilLeaf", fMG:(1, 0),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "LongHorizontalBar", 10),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((110, -5, 15), (135, -5, 15), (55, 10, 10))) }) },
                { (3, 6, 2), new PlantElementTraits("MarshCinquefoilLeafShort",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "SinglePixel", 1),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((110, -5, 15), (135, -5, 15), (55, 10, 10))) }) },
                { (3, 6, 3), new PlantElementTraits("MarshCinquefoilFlower",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0), (2, -1), (2, 1) }, "MarshCinquefoilFlower", 5),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), null) }) },
                ...
                { (4, 40, 0), new PlantElementTraits("SaltbushBase", rET:(from number in Enumerable.Range(0, 12) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(0, 0), hPP:fHPP["Up1Gap"],
                ...
                { (4, 40, -2), new PlantElementTraits("SaltbushStem", sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 1), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 0), mG:(5, 3), sD:((0, 1), (true, false, true)), hPP:fHPP["Up1Gap"],
                ...
                { (10, 3, 0), new PlantElementTraits("AlderTrunk", rET:(from number in Enumerable.Range(0, 30) select ((0, number), (true, false))).ToArray(), sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 5), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 1), mG:(35, 15), hPP:fHPP["Leaves"], sEW:((2, 1, 0, 0), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((10, 3, 3), 0, (0, 0), 0, 100) },
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((10, 3, -1), 0, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((10, 3, -2), 1, (-1, 0), 0, (1, 1), 90), ((10, 3, -2), 1, (1, 0), 0, (1, 1), 90), ((10, 3, -3), 1, (-1, 1), 0, (1, 1), 80), ((10, 3, -3), 1, (1, 1), 0, (1, 1), 80) },
                    lC:true, cO:(3, 0, 0.1f), tSCOGE:true,
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, true), (5, 10), 50) },
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((1, 1, 0, 0), (true, false, false)), (0, 6)), (((1, 0, 0, 0), (true, false, false)), (3, 6)) },
                    eWO:(-10, 6, 0.1f)
                )) },
                { (10, 3, -1), new PlantElementTraits("AlderBranchTerminal",
                pGR:new PlantGrowthRules(t:(1, 1), mG:(5, 2), sD:((0, 1), (true, false, false)), hPP:fHPP["Leaves"],
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((10, 3, 3), 0, (0, 0), 0, 100) }
                )) },
                { (10, 3, -2), new PlantElementTraits("AlderBranchLow",
                pGR:new PlantGrowthRules(t:(1, 1), mG:(6, 3), mGPRV:(0.2f, true), sD:((1, 0), (true, false, false)), hPP:fHPP["Leaves"],
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((10, 3, 1), 2, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((10, 3, 2), 2, (0, 0), 0, (3, 4), 85) },
                    lC:true, cO:(-4, 4, 0),
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((0, 1), (true, false, false), (1, 1), 80), ((0, 1), (true, false, false), (2, 1), 80), ((0, 1), (true, false, false), (3, 2), 65), ((0, 1), (true, false, false), (4, 2), 50) }
                )) },
                { (10, 3, -3), new PlantElementTraits("AlderBranchDiag",
                pGR:new PlantGrowthRules(t:(1, 1), mG:(3, 2), mGPRV:(0.3f, true), sD:((1, 1), (true, false, false)), hPP:fHPP["Leaves"],
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((10, 3, 1), 2, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((10, 3, 2), 2, (0, 0), 0, (3, 4), 85) },
                    lC:true, cO:(-4, 4, 0),
                    DG:new ((int x, int y) direction, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((0, 1), (true, false, true), (2, 2), 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (1, 1), 100), ((1, 0), (true, false, false), (1, 1), 100), ((1, 0), (true, false, false), (2, 1), 100), ((1, 0), (true, false, false), (2, 2), 100), ((1, 0), (true, false, false), (3, 1), 90), ((1, 0), (true, false, false), (3, 2), 80) },
                    pMO:(3, 0, 0)
                )) },
                { (10, 3, 1), new PlantElementTraits("AlderLeavesSticky", stick:((0, 0), (false, false)), fMG:(1, 3),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "AlderLeaves", 5)
                ) },
                { (10, 3, 2), new PlantElementTraits("AlderLeaves", fMG:(1, 3),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "AlderLeaves", 5)
                ) },
                { (10, 3, 3), new PlantElementTraits("AlderLeavesTop", fMG:(1, 3), stick:((0, 0), (false, false)),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "AlderLeavesTerminal", 5)
                ) },

                { (11, 0, 0), new PlantElementTraits("FirTrunk", rET:(from number in Enumerable.Range(0, 20) select ((0, number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(25, 15), hPP:fHPP["Leaves"], sEW:((1, 0, 0, 0), (true, false, false)),
                ...
                pGR:new PlantGrowthRules(t:(1, 1), mG:(30, 15), hPP:fHPP["Leaves"], sEW:((1, 0, 0, 0), (true, false, false)),
                ...
                { (12, 1, 0), new PlantElementTraits("BaldCypressTrunk", rET:(from number in Enumerable.Range(0, 30) select ((0, number), (true, false))).ToArray(), sRET:new ((int x, int y) pos, (int type, int subType) type, (bool x, bool y) baseDirectionFlip)[] { ((0, 20), (0, 0), (true, false)) },
                pGR:new PlantGrowthRules(t:(1, 1), mG:(25, 15), lIMG:1, sEW:((4, 4, 0, 0), (true, false, false)), hPP:fHPP["LeavesMangrove"],
                    ...
                    lPM:true, lIPMO:1,
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((4, 3, 0, 0), (true, false, false)), (1, 1)), (((3, 3, 0, 0), (true, false, false)), (1, 1)), (((3, 2, 0, 0), (true, false, false)), (1, 1)), (((2, 2, 0, 0), (true, false, false)), (1, 1)), (((2, 1, 0, 0), (true, false, false)), (1, 1)), (((1, 1, 0, 0), (true, false, false)), (2, 3)), (((1, 0, 0, 0), (true, false, false)), (3, 4)) },
                    eWO:(-8, 4, 0.1f), lIEWO:0.5f
                )) },
                ...
                { (14, 0, 0), new PlantElementTraits("GiantBaobabTrunk", rET:(from number in Enumerable.Range(0, 55) select ((0, number), (true, false))).ToArray().Concat(from number in Enumerable.Range(-15, 31) select ((number, 38), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(32, 13), lIMG:1, sEW:((3, 3, 0, 0), (true, false, false)),
                ...
                { (14, 0, -1), new PlantElementTraits("GiantBaobabBranchVertical",
                ...
                { (14, 0, -2), new PlantElementTraits("GiantBaobabBranchDiag",
                ...
                { (14, 0, -3), new PlantElementTraits("GiantBaobabBranchSide",
                ...
                { (14, 0, 1), new PlantElementTraits("GiantBaobabLeaves", stick:((0, 0), (false, false)), fMG:(4, 8),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "BaobabLeaves", 12)
                ) },

                { (14, 1, 0), new PlantElementTraits("SuarezBaobabTrunk", rET:(from number in Enumerable.Range(0, 35) select ((0, number), (true, false))).ToArray().Concat(from number in Enumerable.Range(-20, 41) select ((number, 25), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(20, 10), lIMG:1, sEW:((2, 2, 0, 0), (true, false, false)),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 1, -1), 6, (-2, 0), 0, 100), ((14, 1, -1), 6, (2, 0), 0, 100),   ((14, 1, -2), 0, (0, 0), 0, 50) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (4, 4), 65) }
                )) },
                { (14, 1, -1), new PlantElementTraits("SuarezBaobabBranchHorizontal",
                pGR:new PlantGrowthRules(t:(1, 1), mG:(8, 6), sEW:((0, 0, 0, 3), (true, false, false)),
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 1, -2), 0, (0, 0), 0, (2, 1), 45), ((14, 1, -3), 0, (0, 0), 0, (2, 1), 45), ((14, 1, -3), 0, (0, 0), 0, (2, 1), 45) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((0, 1), (true, false, true), (1, 1), 35), ((0, 1), (true, false, true), (2, 1), 55), ((0, 1), (true, false, true), (3, 0), 65) },
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((0, 0, 0, 2), (true, false, false)), (0, 3)), (((0, 0, 0, 1), (true, false, false)), (3, 3)), }
                ), tTOPEOGE:(14, 1, -4)) },
                { (14, 1, -2), new PlantElementTraits("SuarezBaobabBranchVertical",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((0, 1), (true, false, false)), mG:(5, 3), sEW:((1, 0, 0, 0), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 1, 1), 0, (0, 0), 0, 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 0), 45), ((1, 0), (true, false, false), (1, 1), 65) },
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((0, 0, 0, 0), (true, false, false)), (2, 4)),  }
                )) },
                { (14, 1, -3), new PlantElementTraits("SuarezBaobabBranchDiag",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((1, 1), (true, false, false)), mG:(3, 2), sEW:((0, 0, 0, 1), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 1, 1), 0, (0, 0), 0, 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((0, 1), (true, false, true), (1, 1), 100) },
                    lPM:true,
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((0, 0, 0, 0), (true, false, false)), (2, 4)),  }
                )) },
                { (14, 1, -4), new PlantElementTraits("SuarezBaobabBranchHorizontal-2",
                pGR:new PlantGrowthRules(t:(1, 1), mG:(3, 1), sEW:((0, 0, 0, 1), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 1, 1), 0, (0, 0), 0, 100) },
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((0, 0, 0, 0), (true, false, false)), (1, 1)) }
                )) },
                { (14, 1, 1), new PlantElementTraits("SuarezBaobabLeaves", stick:((0, 0), (false, false)), fMG:(6, 7),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0) }, "BaobabSuarezLeaves", 13)
                ) },
                ...
                pGR:new PlantGrowthRules(t:(1, 1), sD:((0, 1), (true, false, false)), mG:(2, 2), sEW:((1, 0, 0, 0), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 10, 1), 0, (0, 0), 0, 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (1, 1), 80), ((1, 0), (true, false, false), (1, 2), 60) }
                )) },
                { (14, 10, 1), new PlantElementTraits("YuccaTreeLeaves", stick:((0, 0), (false, false)), fMG:(6, 4),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0), (1, -1) }, "YuccaTreeLeaves", 11),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, -1), null), ((1, 0), null) }
                ) },

                { (14, 11, 0), new PlantElementTraits("YuccaBeakedTrunk", rET:(from number in Enumerable.Range(0, 25) select ((0, number), (true, false))).ToArray().Concat(from number in Enumerable.Range(-10, 21) select ((number, 15), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(6, 8), lIMG:1, sEW:((1, 1, 0, 0), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 11, 1), 0, (0, 0), 0, 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 2), 45) },
                    lPM:true
                )) },
                { (14, 11, 1), new PlantElementTraits("YuccaBeakedLeaves", stick:((0, 0), (false, false)), fMG:(7, 7),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (1, 0), (1, -1) }, "YuccaBeakedLeaves", 14)
                ) },


                { (14, 20, 0), new PlantElementTraits("DesertRoseTrunk", rET:(from number in Enumerable.Range(0, 20) select ((0, number), (true, false))).ToArray().Concat(from number in Enumerable.Range(-7, 15) select ((number, 10), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(2, 10), pGOCS:2, lIMG:1, sEW:((3, 3, 0, 0), (true, false, false)),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 20, -1), 5, (-3, 0), 0, 90), ((14, 20, -1), 5, (3, 0), 0, 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (8, 12), 45) },
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((3, 2, 0, 0), (true, false, false)), (1, 1)), (((2, 2, 0, 0), (true, false, false)), (1, 1)), (((2, 1, 0, 0), (true, false, false)), (1, 1)), (((1, 1, 0, 0), (true, false, false)), (1, 1)) },
                    eWO:(-5, 4, 0.65f)
                )) },
                { (14, 20, -1), new PlantElementTraits("DesertRoseBranch1",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((0, 1), (true, false, false)), mG:(5, 5), sEW:((1, 0, 0, 0), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 20, 1), 0, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 20, -2), 1, (1, 0), 0, (1, 0), 80), ((14, 20, -2), 1, (-1, 0), 0, (1, 0), 80) },
                    lC:true, cO:(3, 0, 0),
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, true), (0, 0), 15), ((1, 1), (true, false, false), (1, 0), 30), ((1, 1), (true, false, false), (1, 1), 45) },
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (((0, 0, 0, 0), (true, false, false)), (2, 6)),  }
                )) },
                { (14, 20, -2), new PlantElementTraits("DesertRoseBranch2",
                pGR:new PlantGrowthRules(t:(1, 1), mG:(3, 3),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 20, 1), 0, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 20, 2), 0, (0, 0), 0, (1, 2), 35) },
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, true), (1, 3), 100), ((0, 1), (true, false, true), (1, 1), 50) }
                )) },
                { (14, 20, 1), new PlantElementTraits("DesertRoseFlowerSticky", stick:((0, 1), (false, false)), fMG:(1, 2),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0), (2, 1) }, "DesertRoseFlower", 4)
                ) },
                { (14, 20, 2), new PlantElementTraits("DesertRoseFlower", fMG:(1, 2),
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0), (2, 1) }, "DesertRoseFlower", 4)
                ) },

                { (14, 30, 0), new PlantElementTraits("BlackSaxaulTrunk", rET:(from number in Enumerable.Range(0, 35) select ((0, number), (true, false))).ToArray().Concat(from number in Enumerable.Range(-4, 9) select ((number, 3), (true, false))).ToArray().Concat(from number in Enumerable.Range(-5, 11) select ((number, 20), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(25, 15), pGOCS:2, lIMG:1, sEW:((1, 0, 0, 1), (true, false, false)),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 30, -2), 1, (1, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 30, -1), 1, (-1, 0), 0, (6, 2), 75), ((14, 30, -1), 1, (1, 0), 0, (2, 2), 35),    ((14, 30, -2), 1, (1, 0), 0, (5, 2), 30), ((14, 30, -2), 1, (-1, 0), 0, (2, 2), 50), ((14, 30, -2), 1, (1, 0), 0, (5, 2), 80), ((14, 30, -2), 1, (-1, 0), 0, (2, 2), 95)  },
                    cO:(-5, 2, 0.25f),
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (2, 3), 100),    ((0, 1), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (0, 0), 50),    ((1, 1), (true, false, false), (4, 3), 65), ((0, 1), (true, false, false), (1, 2), 100),    ((1, 1), (true, false, false), (4, 3), 40),    ((0, 1), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (0, 0), 30) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 2), 55), ((1, 0), (true, false, false), (1, 0), 25), ((1, 0), (true, false, false), (0, 1), 25) },
                    lPM:true,
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (null, (12, 4)), },
                    eWO:(-10, 1, 0.5f)
                )) },
                { (14, 30, -1), new PlantElementTraits("BlackSaxaulBranchSide",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((1, 0), (true, false, false)), mG:(8, 5), sEW:((1, 0, 0, 1), (true, false, false)),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 30, -2), 1, (1, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 30, -2), 1, (1, 0), 0, (4, 2), 60), ((14, 30, -2), 1, (-1, 0), 0, (2, 2), 90) },
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (2, 3), 100), ((0, 1), (true, false, false), (1, 2), 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 2), 55), ((1, 0), (true, false, false), (1, 0), 25) },
                    lPM:true,
                    EW:new (((int left, int right, int up, int down) width, (bool x, bool y, bool independant) canBeFlipped)?, (int frame, int range) changeFrame)[] { (null, (0, 4)), }
                )) },
                { (14, 30, -2), new PlantElementTraits("BlackSaxaulBranchFinal",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((1, 0), (true, false, false)), mG:(3, 3), mGPRV:(0.5f, true),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 30, 1), 2, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 30, 1), 0, (0, 0), 0, (1, 0), 95), },
                    lC:true,
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (0, 1), 100), ((0, 1), (true, false, false), (1, 2), 100), ((1, 1), (true, false, false), (1, 2), 75), ((0, 1), (true, false, false), (1, 2), 60) },
                    dGO:(-1, 0, 0.25f),
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 85) },
                    lPM:true
                )) },
                { (14, 30, 1), new PlantElementTraits("BlackSaxaulLeaves",
                pGR:new PlantGrowthRules(t:(1, 0), mG:(3, 3), mGPRV:(0.5f, true),
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((0, 1), (true, false, false), (0, 0), 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 55) },
                    lPM:true
                ), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), null) }) },

                { (14, 31, 0), new PlantElementTraits("WhiteSaxaulTrunk", rET:(from number in Enumerable.Range(0, 15) select ((0, number), (true, false))).ToArray().Concat(from number in Enumerable.Range(-3, 7) select ((number, 3), (true, false))).ToArray().Concat(from number in Enumerable.Range(-3, 7) select ((number, 10), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 1), mG:(12, 8), pGOCS:2, lIMG:1,
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 31, -2), 1, (1, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 31, -1), 1, (-1, 0), 0, (1, 2), 65), ((14, 31, -1), 1, (1, 0), 0, (1, 1), 45),    ((14, 31, -2), 1, (1, 0), 0, (3, 2), 50), ((14, 31, -2), 1, (-1, 0), 0, (2, 2), 85), },
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (1, 2), 100),    ((0, 1), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (0, 0), 25),    ((1, 1), (true, false, false), (1, 2), 100),   ((0, 1), (true, false, false), (1, 0), 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 2), 55), ((1, 0), (true, false, false), (1, 0), 25), ((1, 0), (true, false, false), (0, 1), 25) },
                    lPM:true
                )) },
                { (14, 31, -1), new PlantElementTraits("WhiteSaxaulBranchSide",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((1, 0), (true, false, false)), mG:(5, 3),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 31, -2), 1, (1, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 31, -2), 1, (1, 0), 0, (3, 2), 60), ((14, 31, -2), 1, (-1, 0), 0, (2, 1), 90) },
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (0, 2), 100), ((0, 1), (true, false, false), (1, 2), 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 2), 55), ((1, 0), (true, false, false), (1, 0), 25) },
                    lPM:true
                )) },
                { (14, 31, -2), new PlantElementTraits("WhiteSaxaulBranchFinal",
                pGR:new PlantGrowthRules(t:(1, 1), sD:((1, 0), (true, false, false)), mG:(4, 3), mGPRV:(0.25f, true),
                    cOGE:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 31, 1), 2, (0, 0), 0, 100) },
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((14, 31, 1), 0, (0, 0), 0, (1, 0), 95), },
                    lC:true,
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 1), (true, false, false), (0, 1), 100), ((0, 1), (true, false, false), (2, 1), 100) },
                    dGO:(-1, 0, 0.25f),
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 85) },
                    lPM:true
                )) },
                { (14, 31, 1), new PlantElementTraits("WhiteSaxaulLeaves",
                pGR:new PlantGrowthRules(t:(1, 0), mG:(3, 3), mGPRV:(0.5f, true),
                    DG:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((0, 1), (true, false, false), (0, 0), 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 1), 55) },
                    lPM:true
                ...
                pGR:new PlantGrowthRules(t:(1, 1), sD:((0, 1), (true, false, false)), mG:(1, 1), pGOCS:1, sEW:((0, 1, 0, 0), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 40, 1), 0, (0, 0), 0, 100) },
                    cOGESp:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (float baseValue, float variation)? childMaxGrowthVariation, (float baseValue, float variation)? forceGrowthSpeedVariationFactor, int chance)[] { ((14, 40, -3), 5, (3, 0), 0, (-2, 0), (1, 0.1f), 100),    ((14, 40, -3), 5, (2, 0), 0, (-1, 0), (2.5f, 0.1f), 100),    ((14, 40, -3), 5, (1, 0), 0, null, (4.5f, 0.1f), 100),    ((14, 40, -3), 5, (1, 0), 0, null, (8, 0.1f), 100),    ((14, 40, -3), 5, (1, 0), 0, (-9, 7), (1, 2.5f), 35), ((14, 40, -3), 5, (1, 0), 0, (-9, 7), (4, 3), 75) },
                    tSCOGE:true,
                ...
                pGR:new PlantGrowthRules(t:(1, 1), mG:(10, 1), sD:((0, 1), (true, false, false)),
                    cOGS:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, int chance)[] { ((14, 40, 1), 0, (0, 0), 0, 100) },
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (1, 0), 100), ((1, 0), (true, false, false), (2, 0), 100), ((1, 0), (true, false, false), (3, 0), 100), ((1, 0), (true, false, false), (4, 0), 100) }
                ), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 1), null) }) },
                ...
                { (20, 3, 0), new PlantElementTraits("BluebellVine", rET:(from number in Enumerable.Range(0, 20) select ((0, -number), (true, false))).ToArray(),
                pGR:new PlantGrowthRules(t:(1, 0), mG:(15, 25),
                    C:new ((int type, int subType, int subSubType) child, int dirType, (int x, int y) mod, float failMGIncrease, (int frame, int range) birthFrame, int chance)[] { ((20, 3, 1), 0, (0, 0), 0, (3, 4), 100) },
                    lC:true,
                    PM:new ((int x, int y) mod, (bool x, bool y, bool independant) canBeFlipped, (int frame, int range) changeFrame, int chance)[] { ((1, 0), (true, false, false), (2, 0), 100), ((-1, 0), (true, false, false), (2, 0), 100) },
                    lPM:true
                )) },
                { (20, 3, 1), new PlantElementTraits("BluebellVinesFlower",
                framez:makeStructureFrameArray(new (int type, int subType)[]{ (2, 0) }, "BluebellVinesFlower", 4)
                ) },
        ...
        public class PlantTraits
        {
            ...
            public (int r, int g, int b)? fullPlantHue;
            public bool doesFPHOverride;
            public (int r, int g, int b)? fullPlantShade;
            public bool doesFPSOverride;
            public ((int type, int subType) type, ColorRange colorRange)[] colorOverrideArray;
            public float renderingPriority;
            ...
            public (int x, int y)? forbiddenSpawnRange;
            public ((int baseValue, int variation) chance, (int x, int y) range)? propagateOnSuccess;

            public PlantTraits(string n, string sName = "", float rP = 0, (int type, int subType)? iFT = null, int mGFV = 1,
                ...
                bool C = false, bool S = false, bool EA = false, bool J = false, bool W = false, bool A = false, bool lum = false, bool cl = false, (int x, int y)? fSR = null, ((int baseValue, int variation) chance, (int x, int y) range)? pOS = null)
            {
                ...
                fullPlantHue = fPH != null ? fPH.Value.hue : globalNullTuple3;
                doesFPHOverride = fPH != null && fPH.Value.overridePlantElementHue;
                fullPlantShade = fPS != null ? fPS.Value.shade : globalNullTuple3;
                doesFPSOverride = fPS != null && fPS.Value.overridePlantElementShade;
                colorOverrideArray = cOverride;
                renderingPriority = rP;
        ...
        public static void makePlantTraitsDict()
        {
            plantTraitsDict = new Dictionary<(int type, int subType), PlantTraits>()
            {
                ...
                { (0, 0), new PlantTraits("Grass", rP:0, pOS:((1, 5), (7, 5))) },
                { (0, 1), new PlantTraits("Wheat", rP:4, pOS:((5, 7), (7, 5)),
                ...
                { (0, 2), new PlantTraits("Cortaderia", rP:-1, sName:"Cortaderia selloana", pOS:((0, 4), (3, 2)),
                ...
                { (1, 1), new PlantTraits("Allium", rP:5,
                ...
                { (1, 2), new PlantTraits("Big Flower", rP:-1,
                ...
                { (1, 3), new PlantTraits("Bluebell", rP:1, pOS:((2, 6), (12, 5)),
                ...
                { (1, 4), new PlantTraits("Dragon's mouth orchid", rP:80, pOS:((0, 3), (8, 2)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), new ColorRange((205, -10, 15), (105, 0, 15), (235, 10, 15))) }) },
                { (1, 5), new PlantTraits("Rose Pogonia", rP:60, pOS:((0, 3), (8, 2)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), new ColorRange((235, -10, 15), (190, 0, 15), (235, 10, 15))) }) },
                { (1, 6), new PlantTraits("Small White Lady's Slipper", rP:100, pOS:((2, 4), (6, 2)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), new ColorRange((235, 10, 10), (240, 5, 10), (245, 0, 10))) }) },
                { (1, 7), new PlantTraits("Poison Flag", rP:20, pOS:((2, 4), (6, 2)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), new ColorRange((75, 15, 15), (20, 10, 10), (160, -15, 20))) }) },
                { (1, 8), new PlantTraits("Goldenrod", sName:"Solidago patula", rP:4, pOS:((0, 2), (14, 3)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((50, 5, 15), (55, -5, 15), (15, 0, 5))), ((2, 0), new ColorRange((245, 5, 15), (215, -5, 15), (25, 0, 5))) }) },
                { (1, 9), new PlantTraits("Wild sage", sName:"Salvia nemorosa", rP:0.5f, pOS:((3, 4), (8, 3)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((50, 5, 10), (95, 10, 15), (20, -10, 5))), ((2, 0), new ColorRange((100, 20, 15), (60, 0, 10), (135, -20, 20))) }) },
                { (1, 10), new PlantTraits("Nodding sage", sName:"Salvia nutans", rP:0.45f, pOS:((1, 3), (8, 3)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((50, 5, 10), (95, 10, 15), (20, -10, 5))), ((2, 0), new ColorRange((100, 20, 15), (60, 0, 10), (135, -20, 20))) }) },
                { (1, 11), new PlantTraits("Wild Tulip", sName:"Tulipa sylvestris", rP:11, pOS:((2, 3), (14, 5)),
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((2, 0), new ColorRange((250, 10, 20), (210, -10, 15), (70, 5, 5))) }) },
                { (1, 12), new PlantTraits("Nodding Thistle", sName:"Carduus nutans", rP:-1, fSR:(2, 1), pOS:((0, 2), (12, 5)), A:true,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((85, 0, 10), (115, 15, 15), (90, -10, 15))), ((2, 0), new ColorRange((205, 0, 15), (45, 0, 15), (205, 10, 15))) }) },

                { (2, 0), new PlantTraits("Cattail", rP:3, pOS:((0, 4), (5, 2)), W:true,
                ...
                { (2, 1), new PlantTraits("Rice", rP:4, pOS:((4, 8), (9, 3)), W:true,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }) },
                { (2, 2), new PlantTraits("Reed", rP:-10, pOS:((3, 7), (11, 4)), W:true,
                ...
                { (2, 3), new PlantTraits("Papyrus", rP:-8, pOS:((1, 2), (15, 4)), fPS:((30, 40, 25), false), W:true,
                ...
                { (2, 4), new PlantTraits("Bladderwort", rP:50, sName:"Utricularia vulgaris", pOS:((1, 3), (11, 0)), J:true,
                ...
                { (3, 0), new PlantTraits("Rush", rP:2, sName:"Juncus effusus", pOS:((0, 2), (5, 2)), A:true,
                ...
                { (3, 1), new PlantTraits("Butomus", rP:1, sName:"Butomus umbellatus", pOS:((0, 2), (5, 2)), A:true,
                ...
                { (3, 2), new PlantTraits("Marsh Pea", rP:8, pOS:((1, 3), (5, 2)), A:true,
                ...
                { (3, 3), new PlantTraits("Cardinal Flower", rP:5, pOS:((3, 5), (7, 2)), A:true,
                ...
                { (3, 4), new PlantTraits("Whorl Grass", rP:2, pOS:((0, 2), (12, 3)), A:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((120, 5, 15), (165, -10, 30), (110, 15, 20))) }) },
                { (3, 5), new PlantTraits("Glaucous Parnassia", rP:7, pOS:((0, 2), (9, 2)), A:true,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((35, 5, 10), (55, 15, 15), (10, 0, 5))), ((2, 0), new ColorRange((225, 0, 15), (225, 0, 15), (225, 10, 15))) }) },
                { (3, 6), new PlantTraits("Marsh Cinquefoil", rP:5, pOS:((3, 5), (11, 3)), A:true,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 3) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((90, -10, 20), (60, 10, 15), (30, 0, 10))), ((2, -1), new ColorRange((90, 15, 20), (15, 0, 10), (65, -10, 15))), ((2, 0), new ColorRange((130, 15, 20), (30, 0, 10), (60, -10, 15))), ((2, 1), new ColorRange((40, 10, 10), (10, 0, 5), (10, -5, 5))) }) },

                { (4, 0), new PlantTraits("Cactus", rP:-10,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((150, 0, 10), (175, 15, 15), (80, -10, 10))) }) },
                
                { (4, 10), new PlantTraits("Filamentous Yucca", rP:-8, pOS:((0, 2), (25, 16)),
                ...
                { (4, 11), new PlantTraits("Flaccid Yucca", rP:-8, pOS:((0, 2), (25, 16)),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, -1), new ColorRange((65, 10, 15), (85, -15, 20), (30, 5, 10))), ((1, 0), new ColorRange((90, 10, 15), (110, -15, 20), (50, 10, 10))), ((2, 0), new ColorRange((250, 10, 15), (250, 10, 15), (220, -10, 15))) }) },

                { (4, 20), new PlantTraits("Desert Thumb", sName:"Cynomorium coccineum", rP:1000, pOS:((0, 2), (4, 2)),
                ...
                { (4, 30), new PlantTraits("Yellow Cistanche", sName:"Cistanche deserticola", rP:200, pOS:((0, 3), (8, 2)),
                ...
                { (4, 40), new PlantTraits("Saltbush", sName:"Atriplex polycarpa", rP:0.5f,
                ...
                { (5, 0), new PlantTraits("Sphagnum Moss", rP:-2, A:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((140, 20, 20), (175, -20, 25), (0, 5, -15))) }) },
                { (5, 1), new PlantTraits("Red Sphagnum Moss", rP:-1, A:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((160, 15, 20), (70, -10, 10), (100, -10, 10))) }) },



                { (10, 0), new PlantTraits("Tree", rP:-35,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }) },
                { (10, 1), new PlantTraits("Jungle Tree", rP:-40,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }) },
                { (10, 2), new PlantTraits("Weeping Willow", rP:-65,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }, tNC:((-2, 0), (3, 3)), fPS:((35, 35, 35), false), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((60, -10, 20), (145, 20, 20), (80, -15, 20))), ((1, 1), new ColorRange((100, -10, 15), (85, 5, 15), (80, 10, 15))) }) },
                { (10, 3), new PlantTraits("Alder", rP:-130, A:true,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((40, 10, 15), (80, -15, 15), (20, 5, 10))), ((1, 1), new ColorRange((85, -5, 10), (75, 5, 10), (60, -10, 10))) }) },

                { (11, 0), new PlantTraits("Fir", rP:-100,
                ...
                { (11, 1), new PlantTraits("Up Fir", rP:-120,
                sT:new HashSet<(int type, int subType)> { (2, 0), (2, 1), (2, 2) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((5, 0, 20), (65, -15, 20), (45, 15, 20))), ((1, 1), new ColorRange((80, -10, 20), (55, 10, 20), (35, -10, 20))) }) },

                { (12, 0), new PlantTraits("Mangrove Tree", rP:-50, W:true,
                ...
                { (12, 1), new PlantTraits("Bald Cypress", rP:-200, W:true,
                ...
                { (13, 0), new PlantTraits("Cheering Willow", rP:-60,
                tNC:((-3, 0), (3, 3)), fPS:((50, 50, 50), false), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((220, -10, 20), (140, 20, 20), (180, -15, 20))), ((1, 1), new ColorRange((100, -10, 15), (85, 5, 15), (80, 10, 15))) }) },

                { (14, 0), new PlantTraits("Giant Baobab", rP:-400,
                ...
                { (14, 1), new PlantTraits("Suarez Baobab", rP:-300,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((90, -5, 20), (80, 15, 15), (35, -10, 10))), ((1, 1), new ColorRange((160, 10, 0), (135, 5, 0), (105, -10, 0))) }) },

                { (14, 10), new PlantTraits("Yucca Tree", rP:-25,
                fPS:((25, 25, 15), false), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, -1), new ColorRange((65, 10, 15), (85, -15, 20), (30, 5, 10))), ((1, 0), new ColorRange((90, 10, 15), (110, -15, 20), (50, 10, 10))), ((1, 1), new ColorRange((135, 10, 0), (125, 5, 0), (110, -10, 0))) }) },
                { (14, 11), new PlantTraits("Beaked Yucca", rP:-20, pOS:((0, 2), (25, 16)),
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, -1), new ColorRange((65, 10, 15), (85, -15, 20), (30, 5, 10))), ((1, 0), new ColorRange((90, 10, 15), (110, -15, 20), (50, 10, 10))), ((1, 1), new ColorRange((135, 10, 15), (125, 5, 20), (110, -10, 10))) }) },
                
                { (14, 20), new PlantTraits("Desert Rose", sName:"Adenium obesum", rP:-15,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((90, -5, 20), (80, 15, 15), (35, -10, 10))), ((1, 1), new ColorRange((160, 10, 0), (135, 5, 0), (105, -10, 0))), ((2, 0), new ColorRange((255, 10, 30), (110, -20, 15), (165, 10, 20))), ((2, 1), new ColorRange((255, 10, 20), (190, -10, 15), (225, 5, 15))) }) },

                { (14, 30), new PlantTraits("Black Saxaul", sName:"Haloxylon ammodendron", rP:-30,
                fPS:((10, 15, 5), false), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((35, 5, 15), (85, 0, 20), (25, -5, 10))), ((1, 1), new ColorRange((115, 5, 20), (95, 0, 15), (80, -5, 10))) }) },
                { (14, 31), new PlantTraits("White Saxaul", sName:"Haloxylon persicum", rP:-10,
                ...
                { (14, 40), new PlantTraits("Quiver tree", sName:"Aloidendron dichotomum", rP:-27,
                ...
                { (14, 41), new PlantTraits("Giant Quiver tree", sName:"Aloidendron pillansii", rP:-123,
                fPH:((10, 0, -10), false), cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, -1), new ColorRange((140, -15, 15), (125, 15, 15), (25, 0, 10))), ((1, 0), new ColorRange((185, -15, 15), (160, 15, 15), (25, 0, 10))), ((1, 1), new ColorRange((150, 0, 15), (135, 0, 15), (120, 0, 10))) }) },



                { (20, 0), new PlantTraits("Vine", rP:-120, C:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((50, 0, 30), (120, 50, 30), (50, 0, 30))) }) },
                { (20, 1), new PlantTraits("Obsidian Vine", rP:-100, C:true,
                ...
                { (20, 2), new PlantTraits("Ice Vine", rP:-110, C:true,
                ...
                { (20, 3), new PlantTraits("Bluebell Vine", rP:-130, C:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((50, 0, 30), (120, 50, 30), (50, 0, 30))), ((2, 0), new ColorRange((100, -10, 10), (80, 0, 10), (220, 10, 15))), ((2, 1), new ColorRange((160, -10, 10), (140, 0, 10), (240, 5, 10))) }) },


                { (30, 0), new PlantTraits("KelpUpwards", rP:0.01f, W:true,
                iFT:(2, 0)) },
                { (30, 1), new PlantTraits("KelpDownwards", rP:0.01f, C:true, W:true ) },

                { (31, 0), new PlantTraits("Algae 1", rP:11, W:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((65, 0, 20), (110, -10, 20), (50, 30, 20))) }) },
                { (31, 1), new PlantTraits("Algae Bulbous", rP:-16, W:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((45, 0, 10), (80, 10, 10), (30, 20, 10))) }) },
                { (31, 2), new PlantTraits("Algae Ceiling 1", rP:10, C:true, W:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), new ColorRange((65, 0, 20), (110, -10, 20), (50, 30, 20))) }) },



                { (40, 0), new PlantTraits("Mushroom", rP:50) },
                { (41, 0), new PlantTraits("Mold", rP:10000, EA:true) },


                { (50, 0), new PlantTraits("ObsidianPlant", rP:100) },


                { (60, 0), new PlantTraits("IceGrass", rP:0.1f,
                ...
                { (60, 1), new PlantTraits("IceBrutic", rP:15,
                ...
                { (61, 0), new PlantTraits("IceTromel", rP:14,
                sT:new HashSet<(int type, int subType)> { (-2, -1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), famousColorRanges["IceStem"]), ((2, 0), famousColorRanges["IcePetal"]), ((2, 1), famousColorRanges["IcePollen"]) }) },
                { (61, 1), new PlantTraits("IceKital", rP:13,
                sT:new HashSet<(int type, int subType)> { (-2, -1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), famousColorRanges["IceStem"]), ((2, 0), famousColorRanges["IcePetal"]), ((2, 1), famousColorRanges["IcePollen"]) }) },
                
                { (62, 0), new PlantTraits("IceFlokan", rP:12,
                sT:new HashSet<(int type, int subType)> { (-2, -1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), famousColorRanges["IceStem"]), ((2, 0), famousColorRanges["IcePetal"]), ((2, 1), famousColorRanges["IcePollen"]) }) },
                { (62, 1), new PlantTraits("IceOctam", rP:11,
                sT:new HashSet<(int type, int subType)> { (-2, -1) }, cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((1, 0), famousColorRanges["IceStem"]), ((2, 0), famousColorRanges["IcePetal"]), ((2, 1), famousColorRanges["IcePollen"]) }) },



                { (100, 0), new PlantTraits("LanternTree", rP:-100, lum:true) },
                { (100, 1), new PlantTraits("LanternVine", rP:-20, C:true, lum:true) },
                { (100, 2), new PlantTraits("SideLantern", rP:10, S:true, lum:true) },


                { (101, 0), new PlantTraits("Candle", rP:100, lum:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((11, 1), famousColorRanges["Fire"]) }) },
                { (101, 1), new PlantTraits("Chandelier", rP:-1, lum:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((11, 1), famousColorRanges["Fire"]) }) },
                { (101, 2), new PlantTraits("Candelabrum", rP:-100, lum:true,
                cOverride:new ((int type, int subType) type, ColorRange colorRange)[]{ ((11, 1), famousColorRanges["Fire"]) }) },




                { (200, 0), new PlantTraits("FleshVine", rP:10, C:true,
                mGFV:4, sT:new HashSet<(int type, int subType)> { (4, 0), (4, 2) }) },
                { (200, 1), new PlantTraits("FleshTendril", rP:10,
                mGFV:4, sT:new HashSet<(int type, int subType)> { (4, 0), (4, 2) }) },
                { (200, 2), new PlantTraits("FleshTree1", rP:-100,
                mGFV:1, sT:new HashSet<(int type, int subType)> { (4, 0), (4, 2) }) },
                { (200, 3), new PlantTraits("FleshTree2", rP:-90,
                mGFV:1, sT:new HashSet<(int type, int subType)> { (4, 0), (4, 2) }) },


                { (201, 0), new PlantTraits("BoneStalactite", rP:9, C:true,
                mGFV:4, sT:new HashSet<(int type, int subType)> { (4, 1) }) },
                { (201, 1), new PlantTraits("BoneStalagmite", rP:9,
                mGFV:4, sT:new HashSet<(int type, int subType)> { (4, 1) }) },


                { (202, 0), new PlantTraits("Body Hair", rP:5, EA:true, cl:true,
                mGFV:4, sT:new HashSet<(int type, int subType)> { (4, 0), (4, 2) }) },
        ...
        public static void makeFamousTerrainFeaturesTraitsDict()
        {
            famousTFT = new Dictionary<string, TerrainFeaturesTraits>
            {
                ...
                bDT:new Dictionary<(int type, int subType), (int type, int subType)>() { { (2, 2), (9, 0) }, { (2, 3), (9, 2)}, {(2, 5), (9, 4)}, {(2, 6), (9, 1)}, {(2, 7), (9, 3)} }) },
